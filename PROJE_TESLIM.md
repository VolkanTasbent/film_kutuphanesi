...
| 3 | Netlify ile yayına alınabilir çerçeve | ✅ | Vite + `netlify.toml` |
...
| 15 | Netlify yayını | ⏳ | Aşağıdaki adımlarla yayınlayın |

---

## Teslim Formuna Yazılacak Linkler

> GitHub ve Netlify adımlarını tamamladıktan sonra bu alanları doldurun.
...
```
https://film-kutuphanesi.netlify.app
```
*(Netlify size otomatik bir URL verecektir; yukarıdaki örnek yerine kendi URL'nizi yazın.)*
